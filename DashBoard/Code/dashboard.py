...
path_qualifier='/Data/Timeline_Data/'
menu_dict_list=[]
menu_values=[]
...
# Plots 1,2,3 and 5
confirmed_cases_frame=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_confirmed_cases.csv')
recovered_cases_frame=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_recovered_cases.csv')
deaths_cases_frame=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_deaths_cases.csv')
# Plots 4
confirmed_max_date=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_confirmed_max_date.csv')
recovered_max_date=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_recovered_max_date.csv')
deaths_max_date=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_deaths_max_date.csv')
# Plot 6
confirmed_cases_timeline=pd.read_csv(os.getcwd()+path_qualifier+'pre_processed_confirmed_cases_timeline.csv')
                   ...
                   dcc.Graph(
                        ...
                        figure={
                                ...
                                'layout': {
                                    ...
                                    'plot_bgcolor': colors['backgroundrecovered'],
                                    'paper_bgcolor': colors['background'],
                                    'font': {'color': colors['textrateofraise']},
                                    'margin': '0',
                                        'padding': '20px',   
                        ...
                        figure={
                                ...
                                'layout':{
                                    ...
                                    'plot_bgcolor': colors['plotbackground'],
                                        'paper_bgcolor': colors['plotbackground'],
                                        'font': {'color': colors['textrateofraise']},
                                        'yaxis': { 'gridcolor': "#636363", "showline": True},
                                        'xaxis': { 'gridcolor': "#636363", "showline": True},
                                        'style': {  'width': '100%',
                                                    'height': '60px',
                                                    'lineHeight': '60px',
                                                    'borderWidth': '5px',
...
def update_graph(country):
    ...
    data=[]
    for i in country:
        data.append(go.Scatter(x=confirmed_cases_frame[confirmed_cases_frame['Country']==i]['Dates'],
...
def update_graph(single_country):
    #print('country for PIE: ',single_country)
